    ...
    <div className=' container my-[50px]'>
      <div className=" lg:flex justify-between items-center">
        <div className="lg:w-[50%]">
            <div className="">
                <div className="">
                    <h3 className=' font-marn-sans lg:text-[60px] text-[40px] lg:text-start text-center text-[#111111] font-normal '>Your AI-Powered Sales Coach</h3>
        ...
        <div className="lg:w-[50%]">
            <div className="">
                <div className=" flex justify-end relative">
                    <div className=" lg:w-[380px] lg:h-[428px] flex justify-end ">
                        <img src={aboutFure} className=' w-full h-full' alt="" />
                    </div>
                    <div className=" absolute lg:bottom-[-60px] bottom-[-100px]  left-[20px]">

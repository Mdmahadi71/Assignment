    ...
    <div className=' my-[30px]'>
      <div className=" container">
        <div className=" bg-[#004FCE] py-[80px] rounded-[20px]">
           ...
           <button className=' bg-[#FCE38A] py-2 px-3 rounded-[50px] flex justify-center items-center text-black leading-6 font-marn-sans font-medium text-[16px]'>Join now</button>
           </div>
        </div>
      </div>
    </div>
